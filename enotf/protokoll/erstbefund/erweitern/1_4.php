                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/erstbefund/erweitern/1_4.php?enr=<?= $daten['enr'] ?>" data-requires="v_muster_a" class="active">
                                <span>Abdomen</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="v_muster_a-1" name="v_muster_a" value="1" <?php echo ($daten['v_muster_a'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_a-1">keine</label>

                            <input type="radio" class="btn-check" id="v_muster_a-2" name="v_muster_a" value="2" <?php echo ($daten['v_muster_a'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_a-2">leicht</label>

                            <input type="radio" class="btn-check" id="v_muster_a-3" name="v_muster_a" value="3" <?php echo ($daten['v_muster_a'] == 3 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_a-3">mittel</label>

                            <input type="radio" class="btn-check" id="v_muster_a-4" name="v_muster_a" value="4" <?php echo ($daten['v_muster_a'] == 4 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_a-4">schwer</label>

                            <input type="radio" class="btn-check" id="v_muster_a-99" name="v_muster_a" value="99" <?php echo ($daten['v_muster_a'] == 99 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_a-99">Nicht untersucht</label>
                        </div>
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="v_muster_a1-1" name="v_muster_a1" value="1" <?php echo ($daten['v_muster_a1'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_a1-1">offen</label>

                            <input type="radio" class="btn-check" id="v_muster_a1-2" name="v_muster_a1" value="2" <?php echo ($daten['v_muster_a1'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_a1-2">geschlossen</label>
                        </div>
                    </div>
                </div>
            </div>
