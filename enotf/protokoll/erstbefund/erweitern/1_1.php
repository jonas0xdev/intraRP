            ...
            <div class="row h-100">
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            <a href="<?= BASE_PATH ?>enotf/protokoll/erstbefund/erweitern/1_1.php?enr=<?= $daten['enr'] ?>" data-requires="v_muster_k" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="v_muster_k-1" name="v_muster_k" value="1" <?php echo ($daten['v_muster_k'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_k-1">keine</label>

                            <input type="radio" class="btn-check" id="v_muster_k-2" name="v_muster_k" value="2" <?php echo ($daten['v_muster_k'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_k-2">leicht</label>

                            <input type="radio" class="btn-check" id="v_muster_k-3" name="v_muster_k" value="3" <?php echo ($daten['v_muster_k'] == 3 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_k-3">mittel</label>

                            <input type="radio" class="btn-check" id="v_muster_k-4" name="v_muster_k" value="4" <?php echo ($daten['v_muster_k'] == 4 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_k-4">schwer</label>

                            <input type="radio" class="btn-check" id="v_muster_k-99" name="v_muster_k" value="99" <?php echo ($daten['v_muster_k'] == 99 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_k-99">Nicht untersucht</label>
                        </div>
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="v_muster_k1-1" name="v_muster_k1" value="1" <?php echo ($daten['v_muster_k1'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_k1-1">offen</label>

                            <input type="radio" class="btn-check" id="v_muster_k1-2" name="v_muster_k1" value="2" <?php echo ($daten['v_muster_k1'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_k1-2">geschlossen</label>
                        </div>
                    </div>
                </div>
            </div>
