                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/erstbefund/erweitern/1_3.php?enr=<?= $daten['enr'] ?>" data-requires="v_muster_t" class="active">
                                <span>Thorax</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="v_muster_t-1" name="v_muster_t" value="1" <?php echo ($daten['v_muster_t'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_t-1">keine</label>

                            <input type="radio" class="btn-check" id="v_muster_t-2" name="v_muster_t" value="2" <?php echo ($daten['v_muster_t'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_t-2">leicht</label>

                            <input type="radio" class="btn-check" id="v_muster_t-3" name="v_muster_t" value="3" <?php echo ($daten['v_muster_t'] == 3 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_t-3">mittel</label>

                            <input type="radio" class="btn-check" id="v_muster_t-4" name="v_muster_t" value="4" <?php echo ($daten['v_muster_t'] == 4 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_t-4">schwer</label>

                            <input type="radio" class="btn-check" id="v_muster_t-99" name="v_muster_t" value="99" <?php echo ($daten['v_muster_t'] == 99 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_t-99">Nicht untersucht</label>
                        </div>
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="v_muster_t1-1" name="v_muster_t1" value="1" <?php echo ($daten['v_muster_t1'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_t1-1">offen</label>

                            <input type="radio" class="btn-check" id="v_muster_t1-2" name="v_muster_t1" value="2" <?php echo ($daten['v_muster_t1'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="v_muster_t1-2">geschlossen</label>
                        </div>
                    </div>
                </div>
            </div>
