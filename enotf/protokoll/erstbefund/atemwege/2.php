                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/erstbefund/atemwege/2.php?enr=<?= $daten['enr'] ?>" data-requires="zyanose_1" class="active">
                                <span>Zyanose</span>
                            </a>
                        </div>
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="zyanose_1-1" name="zyanose_1" value="1" <?php echo ($daten['zyanose_1'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="zyanose_1-1" class="edivi__unauffaellig">Nein</label>

                            <input type="radio" class="btn-check" id="zyanose_1-2" name="zyanose_1" value="2" <?php echo ($daten['zyanose_1'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="zyanose_1-2">Ja</label>
                        </div>
                    </div>
                </div>
            </div>
