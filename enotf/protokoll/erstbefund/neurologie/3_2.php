                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/erstbefund/neurologie/3_2.php?enr=<?= $daten['enr'] ?>" data-requires="d_lichtreakt_1,d_lichtreakt_2" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            ...
                            <input type="radio" class="btn-check" id="d_lichtreakt_1-1" name="d_lichtreakt_1" value="1" <?php echo ($daten['d_lichtreakt_1'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_1-1">prompt</label>

                            <input type="radio" class="btn-check" id="d_lichtreakt_1-2" name="d_lichtreakt_1" value="2" <?php echo ($daten['d_lichtreakt_1'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_1-2">träge</label>

                            <input type="radio" class="btn-check" id="d_lichtreakt_1-3" name="d_lichtreakt_1" value="3" <?php echo ($daten['d_lichtreakt_1'] == 3 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_1-3">keine</label>

                            <input type="radio" class="btn-check" id="d_lichtreakt_1-99" name="d_lichtreakt_1" value="99" <?php echo ($daten['d_lichtreakt_1'] == 99 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_1-99">Nicht untersucht</label>
                        </div>
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <label class="edivi__interactbutton-text">rechts</label>

                            <input type="radio" class="btn-check" id="d_lichtreakt_2-1" name="d_lichtreakt_2" value="1" <?php echo ($daten['d_lichtreakt_2'] == 1 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_2-1">prompt</label>

                            <input type="radio" class="btn-check" id="d_lichtreakt_2-2" name="d_lichtreakt_2" value="2" <?php echo ($daten['d_lichtreakt_2'] == 2 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_2-2">träge</label>

                            <input type="radio" class="btn-check" id="d_lichtreakt_2-3" name="d_lichtreakt_2" value="3" <?php echo ($daten['d_lichtreakt_2'] == 3 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_2-3">keine</label>

                            <input type="radio" class="btn-check" id="d_lichtreakt_2-99" name="d_lichtreakt_2" value="99" <?php echo ($daten['d_lichtreakt_2'] == 99 ? 'checked' : '') ?> autocomplete="off">
                            <label for="d_lichtreakt_2-99">Nicht untersucht</label>
                        </div>
                    </div>
                </div>
            </div>
