                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/1_10_7.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>Becken</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="diagnose_haupt-161" name="diagnose_haupt" value="161" <?php echo ($daten['diagnose_haupt'] == 161 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-161">leicht</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-162" name="diagnose_haupt" value="162" <?php echo ($daten['diagnose_haupt'] == 162 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-162">mittel</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-163" name="diagnose_haupt" value="163" <?php echo ($daten['diagnose_haupt'] == 163 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-163">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
