                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10_6.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>BWS / LWS</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-151" name="diagnose_weitere[]" value="151" <?php echo (in_array(151, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-151">leicht</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-152" name="diagnose_weitere[]" value="152" <?php echo (in_array(152, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-152">mittel</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-153" name="diagnose_weitere[]" value="153" <?php echo (in_array(153, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-153">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
