                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/1_10_8.php?enr=<?= $daten['enr'] ?>" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="diagnose_haupt-171" name="diagnose_haupt" value="171" <?php echo ($daten['diagnose_haupt'] == 171 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-171">leicht</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-172" name="diagnose_haupt" value="172" <?php echo ($daten['diagnose_haupt'] == 172 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-172">mittel</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-173" name="diagnose_haupt" value="173" <?php echo ($daten['diagnose_haupt'] == 173 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-173">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
