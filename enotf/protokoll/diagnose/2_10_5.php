                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10_5.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>Abdomen</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-141" name="diagnose_weitere[]" value="141" <?php echo (in_array(141, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-141">leicht</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-142" name="diagnose_weitere[]" value="142" <?php echo (in_array(142, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-142">mittel</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-143" name="diagnose_weitere[]" value="143" <?php echo (in_array(143, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-143">schwer</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-144" name="diagnose_weitere[]" value="144" <?php echo (in_array(144, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-144">tödlich</label>
                        </div>
                    </div>
                </div>
            </div>
