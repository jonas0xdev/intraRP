            ...
            <div class="row h-100">
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_1.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>ZNS</span>
                            </a>
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10.php?enr=<?= $daten['enr'] ?>">
                                <span>Trauma</span>
                            </a>
                        </div>
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-1" name="diagnose_weitere[]" value="1" <?php echo (in_array(1, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-1">Schlaganfall / TIA / ICB</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-2" name="diagnose_weitere[]" value="2" <?php echo (in_array(2, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-2">ICB (klin. Diagn.)</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-3" name="diagnose_weitere[]" value="3" <?php echo (in_array(3, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-3">SAB (klin. Diagn.)</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-4" name="diagnose_weitere[]" value="4" <?php echo (in_array(4, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-4">Krampfanfall</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-5" name="diagnose_weitere[]" value="5" <?php echo (in_array(5, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-5">Status Epilepticus</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-6" name="diagnose_weitere[]" value="6" <?php echo (in_array(6, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-6">Meningitis / Encephalitis</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-9" name="diagnose_weitere[]" value="9" <?php echo (in_array(9, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-9">sonstige Erkrankung ZNS</label>
                        </div>
                    </div>
                </div>
            </div>
