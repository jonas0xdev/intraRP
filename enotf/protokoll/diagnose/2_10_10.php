...
<head>
    ...
    <link rel="apple-touch-icon" sizes="190x190" href="<?= BASE_PATH ?>assets/favicon/apple-touch-icon.png" />
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10_10.php?enr=<?= $daten['enr'] ?>" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-191" name="diagnose_weitere[]" value="191" <?php echo (in_array(191, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-191">leicht</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-192" name="diagnose_weitere[]" value="192" <?php echo (in_array(192, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-192">mittel</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-193" name="diagnose_weitere[]" value="193" <?php echo (in_array(193, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-193">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
