                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/1_10_6.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>BWS / LWS</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="diagnose_haupt-151" name="diagnose_haupt" value="151" <?php echo ($daten['diagnose_haupt'] == 151 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-151">leicht</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-152" name="diagnose_haupt" value="152" <?php echo ($daten['diagnose_haupt'] == 152 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-152">mittel</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-153" name="diagnose_haupt" value="153" <?php echo ($daten['diagnose_haupt'] == 153 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-153">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
