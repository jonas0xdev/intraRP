            ...
            <div class="row h-100">
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/1_10_1.php?enr=<?= $daten['enr'] ?>" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="diagnose_haupt-101" name="diagnose_haupt" value="101" <?php echo ($daten['diagnose_haupt'] == 101 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-101">leicht</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-102" name="diagnose_haupt" value="102" <?php echo ($daten['diagnose_haupt'] == 102 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-102">mittel</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-103" name="diagnose_haupt" value="103" <?php echo ($daten['diagnose_haupt'] == 103 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-103">schwer</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-104" name="diagnose_haupt" value="104" <?php echo ($daten['diagnose_haupt'] == 104 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-104">tödlich</label>
                        </div>
                    </div>
                </div>
            </div>
