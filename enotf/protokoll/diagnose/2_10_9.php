                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10_9.php?enr=<?= $daten['enr'] ?>" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-181" name="diagnose_weitere[]" value="181" <?php echo (in_array(181, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-181">leicht</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-182" name="diagnose_weitere[]" value="182" <?php echo (in_array(182, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-182">mittel</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-183" name="diagnose_weitere[]" value="183" <?php echo (in_array(183, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-183">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
