                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/1_10_3.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>HWS</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="diagnose_haupt-121" name="diagnose_haupt" value="121" <?php echo ($daten['diagnose_haupt'] == 121 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-121">leicht</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-122" name="diagnose_haupt" value="122" <?php echo ($daten['diagnose_haupt'] == 122 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-122">mittel</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-123" name="diagnose_haupt" value="123" <?php echo ($daten['diagnose_haupt'] == 123 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-123">schwer</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-124" name="diagnose_haupt" value="124" <?php echo ($daten['diagnose_haupt'] == 124 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-124">tödlich</label>
                        </div>
                    </div>
                </div>
            </div>
