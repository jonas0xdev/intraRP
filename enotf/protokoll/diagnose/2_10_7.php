                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10_7.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>Becken</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-161" name="diagnose_weitere[]" value="161" <?php echo (in_array(161, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-161">leicht</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-162" name="diagnose_weitere[]" value="162" <?php echo (in_array(162, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-162">mittel</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-163" name="diagnose_weitere[]" value="163" <?php echo (in_array(163, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-163">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
