                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/1_10_10.php?enr=<?= $daten['enr'] ?>" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="radio" class="btn-check" id="diagnose_haupt-191" name="diagnose_haupt" value="191" <?php echo ($daten['diagnose_haupt'] == 191 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-191">leicht</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-192" name="diagnose_haupt" value="192" <?php echo ($daten['diagnose_haupt'] == 192 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-192">mittel</label>

                            <input type="radio" class="btn-check" id="diagnose_haupt-193" name="diagnose_haupt" value="193" <?php echo ($daten['diagnose_haupt'] == 193 ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_haupt-193">schwer</label>
                        </div>
                    </div>
                </div>
            </div>
