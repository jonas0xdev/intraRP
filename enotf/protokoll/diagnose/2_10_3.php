                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            ...
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10_3.php?enr=<?= $daten['enr'] ?>" class="active">
                                <span>HWS</span>
                            </a>
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-121" name="diagnose_weitere[]" value="121" <?php echo (in_array(121, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-121">leicht</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-122" name="diagnose_weitere[]" value="122" <?php echo (in_array(122, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-122">mittel</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-123" name="diagnose_weitere[]" value="123" <?php echo (in_array(123, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-123">schwer</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-124" name="diagnose_weitere[]" value="124" <?php echo (in_array(124, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-124">tödlich</label>
                        </div>
                    </div>
                </div>
            </div>
