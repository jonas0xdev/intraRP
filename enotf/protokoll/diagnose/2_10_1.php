            ...
            <div class="row h-100">
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            <a href="<?= BASE_PATH ?>enotf/protokoll/diagnose/2_10_1.php?enr=<?= $daten['enr'] ?>" class="active">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton">
                            <input type="checkbox" class="btn-check" id="diagnose_weitere-101" name="diagnose_weitere[]" value="101" <?php echo (in_array(101, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-101">leicht</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-102" name="diagnose_weitere[]" value="102" <?php echo (in_array(102, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-102">mittel</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-103" name="diagnose_weitere[]" value="103" <?php echo (in_array(103, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-103">schwer</label>

                            <input type="checkbox" class="btn-check" id="diagnose_weitere-104" name="diagnose_weitere[]" value="104" <?php echo (in_array(104, $diagnose_weitere) ? 'checked' : '') ?> autocomplete="off">
                            <label for="diagnose_weitere-104">tödlich</label>
                        </div>
                    </div>
                </div>
            </div>
