                    ...
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-1 d-flex flex-column edivi__interactbutton">
                            ...
                            foreach ($currentZugaenge as $zugang) {
                                if ($zugang['art'] === 'pvk' && $zugang['ort'] === 'Ellenbeuge' && $zugang['seite'] === 'links') {
                            ...
                            foreach ($groessen as $index => $groesse):
                                $radioId = "c_zugang-pvk-ellenbeuge-l-" . ($index + 1);
                                $zugangData = [
                                    'art' => 'pvk',
                                    'groesse' => $groesse,
                                    'ort' => 'Ellenbeuge',
                            ...
                            ?>
                                <input type="checkbox" class="btn-check zugang-checkbox"
                                    ...
                                    data-location="pvk-ellenbeuge-links"
                                    <?= $isChecked ? 'checked' : '' ?>
                                    autocomplete="off">
                        ...
                        <div class="col-1 d-flex flex-column edivi__interactbutton">
                            ...
                            foreach ($currentZugaenge as $zugang) {
                                if ($zugang['art'] === 'pvk' && $zugang['ort'] === 'Ellenbeuge' && $zugang['seite'] === 'rechts') {
                            ...
                            foreach ($groessen as $index => $groesse):
                                $radioId = "c_zugang-pvk-ellenbeuge-r-" . ($index + 1);
                                $zugangData = [
                                    'art' => 'pvk',
                                    'groesse' => $groesse,
                                    'ort' => 'Ellenbeuge',
                            ...
                            ?>
                                <input type="checkbox" class="btn-check zugang-checkbox"
                                    ...
                                    name="zugang_selection"
                                    data-zugang='<?= htmlspecialchars(json_encode($zugangData), ENT_QUOTES) ?>'
                                    data-location="pvk-ellenbeuge-rechts"
                                    <?= $isChecked ? 'checked' : '' ?>
                                    autocomplete="off">
                                <label for="<?= $radioId ?>" class="edivi__zugang-<?= $groesse ?>"><?= $groesse ?></label>
                            <?php endforeach; ?>
