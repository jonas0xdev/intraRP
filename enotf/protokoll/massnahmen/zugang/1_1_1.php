            ...
            <div class="row h-100">
                ...
                <div class="col" id="edivi__content" style="padding-left: 0">
                    <div class="row" style="margin-left: 0">
                        ...
                        <div class="col-2 d-flex flex-column edivi__interactbutton-more">
                            <a href="<?= BASE_PATH ?>enotf/protokoll/massnahmen/zugang/1_1_1.php?enr=<?= $daten['enr'] ?>" class="active">
                        ...
                        <div class="col-1 d-flex flex-column edivi__interactbutton">
                            ...
                            foreach ($currentZugaenge as $zugang) {
                                if ($zugang['art'] === 'pvk' && $zugang['ort'] === 'Handrücken' && $zugang['seite'] === 'links') {
                            ...
                            foreach ($groessen as $index => $size):
                                $idSlug   = $size['id'];
                                $labelTxt = $size['label'];
                                $inputId  = "c_zugang-pvk-handruecken-l-" . ($index + 1);
                            ...
                            ?>
                                <input
                                    ...
                                    data-location="pvk-handruecken-links"
                                    <?= $isChecked ? 'checked' : '' ?>
                                    autocomplete="off">
                        ...
                        <div class="col-1 d-flex flex-column edivi__interactbutton">
                            ...
                            foreach ($currentZugaenge as $zugang) {
                                if ($zugang['art'] === 'pvk' && $zugang['ort'] === 'Handrücken' && $zugang['seite'] === 'rechts') {
                            ...
                            foreach ($groessen as $index => $size):
                                $idSlug   = $size['id'];
                                $labelTxt = $size['label'];
                                $inputId  = "c_zugang-pvk-handruecken-r-" . ($index + 1);
                            ...
                            ?>
                                <input
                                    ...
                                    name="zugang_selection"
                                    data-zugang='<?= htmlspecialchars(json_encode($zugangData), ENT_QUOTES) ?>'
                                    data-location="pvk-handruecken-rechts"
                                    <?= $isChecked ? 'checked' : '' ?>
                                    autocomplete="off">
                                <label for="<?= $inputId ?>" class="edivi__zugang-<?= $idSlug ?>"><?= $labelTxt ?></label>
                            <?php endforeach; ?>
