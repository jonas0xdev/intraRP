...
<head>
    <meta charset="UTF-8" />
    <title>Antragstyp bearbeiten &rsaquo; <?php echo SYSTEM_NAME ?></title>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <h1><i class="<?= htmlspecialchars($typ['icon']) ?> me-2"></i><?= htmlspecialchars($typ['name']) ?> bearbeiten</h1>
                    ...
                    <div class="intra__tile p-4 mb-4">
                        <h4 class="mb-3"><i class="las la-cog me-2"></i>Grundeinstellungen</h4>
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <i id="icon-preview" class="<?= htmlspecialchars($typ['icon']) ?> fs-4"></i>
                                        </span>
                                        <input type="text" class="form-control" id="icon" name="icon"
                                            value="<?= htmlspecialchars($typ['icon']) ?>">
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                            ...
                            <button type="submit" name="update_typ" class="btn btn-primary">
                                <i class="las la-save me-2"></i>Speichern
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="intra__tile p-4 mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4><i class="las la-list me-2"></i>Formularfelder (<?= count($felder) ?>)</h4>
                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addFeldModal">
                                <i class="las la-plus me-1"></i>Feld hinzufügen
                            </button>
                        </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($felder as $feld): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?= $feld['pflichtfeld'] ? '<i class="las la-check text-success"></i>' : '<i class="las la-times text-muted"></i>' ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?= $feld['readonly'] ? '<i class="las la-lock text-warning"></i>' : '<i class="las la-unlock text-muted"></i>' ?>
                                                    </td>
                                                    <td class="text-end">
            ...
            <div class="modal-content bg-dark">
                <form method="post">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="las la-plus me-2"></i>Neues Feld hinzufügen</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="add_feld" class="btn btn-success">
                            <i class="las la-plus me-2"></i>Feld hinzufügen
                        </button>
                    </div>
                </form>
            </div>
