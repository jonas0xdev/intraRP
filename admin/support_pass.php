...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="las la-key"></i> Support-Passwort-Manager</h1>
            <p>Erstellen Sie temporäre Zugangsdaten für Support-Mitarbeiter</p>
        </div>

        <?php if ($success): ?>
            <div class="alert alert-success">
                <i class="las la-check-circle" style="font-size: 20px;"></i>
        ...
        <?php if ($generated_data): ?>
            <div class="card">
                <h2><i class="las la-check-circle"></i> Support-Zugang erstellt</h2>
                    ...
                    <div class="generated-item">
                        ...
                        <div class="value">
                            ...
                            <button class="copy-btn" onclick="copyToClipboard('token')">
                                <i class="las la-copy"></i> Kopieren
                            </button>
                        </div>
                    </div>
        ...
        <div class="card">
            <h2><i class="las la-plus-circle"></i> Neues Support-Passwort erstellen</h2>
        ...
        <div class="card">
            <h2><i class="las la-history"></i> Ihre Support-Passwörter</h2>

            <?php if (empty($passwords)): ?>
                <p style="color: #6c757d; text-align: center; padding: 40px 0;">
                    <i class="las la-info-circle" style="font-size: 48px; display: block; margin-bottom: 16px;"></i>
    ...
    <script>
        function copyToClipboard(elementId) {
            ...
            navigator.clipboard.writeText(text).then(() => {
                ...
                btn.innerHTML = '<i class="las la-check"></i> Kopiert!';
