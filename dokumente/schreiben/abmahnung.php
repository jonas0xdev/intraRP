...
<head>
    ...
    <title>Abmahnung &rsaquo; <?php echo SYSTEM_NAME ?></title>
    <!-- Stylesheets -->
    ...
    <?php echo '<meta property="og:title" content="Abmahnung > ' . $row['erhalter'] . '" />'; ?>
    ...
    <div class="page-container">
        <div class="page shadow mx-auto mt-2 bg-light" id="page1">
            ...
            <div class="letter-content">
                ...
                <p>hiermit werden Sie schriftlich bezüglich der unten genannten Vorfälle abgemahnt.</p>
                <p>Sollten Sie weiterhin dienstlich auffällig werden, müssen Sie mit weiteren dienstrechtlichen Konsequenzen bis hin zur Dienstentfernung rechnen.</p>
                <p>Der Grund der Abmahnung lautet:</p>
