...
if ($row['anrede'] == 1) {
    $qualifikation = isset($qualisF[$dq]) ? $qualisF[$dq] : '';
} elseif ($row['anrede'] == 0) {
    $qualifikation = isset($qualisM[$dq]) ? $qualisM[$dq] : '';
} else {
...
<head>
    ...
    <title>Lehrgangszertifikat &rsaquo; <?php echo SYSTEM_NAME ?></title>
    <!-- Stylesheets -->
    ...
    <?php echo '<meta property="og:title" content="Lehrgangszertifikat > ' . $row['erhalter'] . '" />'; ?>
    <meta property="og:image" content="<?php echo META_IMAGE_URL ?>" />
    <?php echo '<meta property="og:description" content="Zertifikat des Lehrgangs ' . $zum . ' ' . $qualifikation . '" />'; ?>
</head>
    ...
    <div class="page-container">
        <div class="page shadow mx-auto mt-4 mb-4 bg-light" id="page-urkunde">
            ...
            <div class="urkunde-body text-center">
                ...
                <p class="my-5">den Lehrgang <?= $zum ?></p>
                <p class="urkunde-important"><?= $qualifikation ?></p>
                <p class="my-5">gem. LAPVOFeu am <?= $ausstelldatum ?> erfolgreich absolviert und somit die Genehmigung zum Führen der Qualifikation erworben hat.</p>
            </div>
