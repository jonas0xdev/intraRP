...
<head>
    ...
    <title>Entlassungsurkunde &rsaquo; <?php echo SYSTEM_NAME ?></title>
    <!-- Stylesheets -->
    ...
    <?php echo '<meta property="og:title" content="Entlassungsurkunde > ' . $row['erhalter'] . '" />'; ?>
    <meta property="og:image" content="<?php echo META_IMAGE_URL ?>" />
    <?php echo '<meta property="og:description" content="Verwaltungsportal der ' . RP_ORGTYPE . ' ' .  SERVER_CITY . '" />'; ?>
</head>
    ...
    <div class="page-container">
        <div class="page shadow mx-auto mt-4 mb-4 bg-light" id="page-urkunde">
            ...
            <div class="urkunde-body text-center">
                <p class="my-5">Im Namen der Stadt <?php echo SERVER_CITY ?></p>
                <p>wird <?= $anrede ?></p>
                <p class="urkunde-important"><?= $row['erhalter'] ?></p>
                <p>» geb. am <?= $formatted_date ?> «</p>
                <p class="my-5">auf eigenes Verlangen mit sofortiger Wirkung aus dem Beamtenverhältnis sowie aus dem Dienst der <?php echo RP_ORGTYPE . " " . SERVER_CITY ?> entlassen.</p>
                <p class="my-5">Für
                    <?php if ($row['anrede'] == 1) {
                        echo "Ihre";
                    } elseif ($row['anrede'] == 0) {
                    ...
                    ?>
                    geleisteten Dienste sprechen wir
                    <?php if ($row['anrede'] == 1) {
                        echo "Ihr";
                    } elseif ($row['anrede'] == 0) {
                        echo "Ihm";
