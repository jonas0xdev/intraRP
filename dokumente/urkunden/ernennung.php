...
<head>
    ...
    <title>Ernennungsurkunde &rsaquo; <?php echo SYSTEM_NAME ?></title>
    <!-- Stylesheets -->
    ...
    <?php echo '<meta property="og:title" content="Ernennungsurkunde > ' . $row['erhalter'] . '" />'; ?>
    <meta property="og:image" content="<?php echo META_IMAGE_URL ?>" />
    <?php echo '<meta property="og:description" content="Ernnennung ' . $zum . ' ' . $dienstgrad . ' der ' . RP_ORGTYPE . ' ' . SERVER_CITY . '" />'; ?>
</head>
    ...
    <div class="page-container">
        <div class="page shadow mx-auto mt-4 mb-4 bg-light" id="page-urkunde">
            ...
            <div class="urkunde-body text-center">
                ...
                <p class="my-5">
                    <?= $zum ?>
                    Beamten der <?php echo RP_ORGTYPE . " " . SERVER_CITY ?> ernannt.</p>
            </div>
