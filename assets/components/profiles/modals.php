...
?>
    ...
    <script type="module">
        ...
        document.getElementById('templateSelect')?.addEventListener('change', async function() {
            ...
            try {
                const response = await fetch(BASE_PATH + `assets/functions/documents/get.php?id=${templateId}`);
        ...
        document.getElementById('newDocForm')?.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch(BASE_PATH + 'assets/functions/documents/create-custom.php', {
                    method: 'POST',
                    headers: {
